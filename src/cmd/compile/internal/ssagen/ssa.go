...
func InitConfig() {
	...
	ir.Syms.Freeslice = typecheck.LookupRuntimeFunc("freeslice")
	ir.Syms.Freestring = typecheck.LookupRuntimeFunc("freestring")
	ir.Syms.Freemap = typecheck.LookupRuntimeFunc("freemap")
	ir.Syms.Freechan = typecheck.LookupRuntimeFunc("freechan")
